...
INPUT FILE:     (1) C:\MEPS\SAS\DATA\H193.SAS7BDAT (PANEL 20 LONGITUDINAL FILE)
	            (2) C:\MEPS\SAS\DATA\H183.SAS7BDAT (PANEL 19 LONGITUDINAL FILE)
	            (3) C:\MEPS\SAS\DATA\H172.SAS7BDAT (PANEL 18 LONGITUDINAL FILE)
...
%LET MyFolder= S:\CFACT\Shared\WORKSHOPS\2019\Fall2019\SAS\Exercise_4;
...
OPTIONS NODATE;
TITLE1 '2019 AHRQ MEPS DATA USERS WORKSHOP (EXERCISE4.SAS)';
TITLE2 'POOL MEPS DATA FILES FROM DIFFERENT PANELS (PANELS 18, 19, and 20)';
...
DATA WORK.POOL;
     LENGTH INSCOVY1 INSCOVY2 PANEL AGEY1X POVCATY1 VARSTR VARPSU 8;
	   SET CDATA.H172 (KEEP=DUPERSID INSCOVY1 INSCOVY2 LONGWT VARSTR VARPSU POVCATY1 AGEY1X PANEL)
...
proc print data= work.domain_results noobs split='*';
 ...
 label mean = 'Proportion'
       ...
       format N Comma12. mean 7.3 stderr 7.5;             
run;
